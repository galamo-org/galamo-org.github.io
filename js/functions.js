...
function maintainer_translator(maint, pkgnm) {
    ...
    if (_email_with_name_regex.test(maint)) {
        ...
        url = 'mailto:' + match[2] + '?subject=Galamo%20affiliated%20package%20' + pkgnm;
        return '<a href="' + url + '">' + match[1] + '</a>';
    } else if (_email_regex.test(maint)) {
        url = 'mailto:' + maint + '?subject=Galamo%20affiliated%20package%20' + pkgnm;
    ...
    roles.forEach(function (role) {
        ...
        role["sub-roles"].forEach(function (subrole) {
            ...
            if (subrole['people'][0] == "Unfilled") {
                rowPeople = '<a href="mailto:coordinators@Galamo.org"><span style="font-style: italic;">Unfilled</span></a>';
            } else {
...
var review_name_map = {"functionality": "Functionality",
    "ecointegration": "Galamo%20integration",
    "documentation": "Docs",
    "testing": "Tests",
